                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="promo-wrap">
                            <h1 class="promo-title"><span>Our</span> Gallery</h1>
                        ...
                        <div id="collapseTwo" class="accordion-collapse collapse show" data-bs-parent="#accordionExample">
                            <div class="accordion-body">
                                <div class="demo-gallery">
                                    <ul id="lightgallery" class="list-unstyled row row-cols-2 row-cols-md-3 row-cols-lg-5 g-3">
                                        <?php
                                        ...
                                        if ($result->num_rows > 0) {
                                            while ($row = $result->fetch_assoc()) {
                                                ...
                                                <li class='col' data-src='images/gallery/$picturePath' data-sub-html='<h4>$eventName</h4>'>
                                                    <a href=''>
                                                        <img class='img-responsive' src='images/gallery/$pathinfo_FILENAME.$pathinfo_EXTENSION' alt='MosesMoradeun Charity Foundation Picture Thumb'>
                                                    </a>
                                                </li>";
                                            }
                                        } else {
                        ...
                        <div id="collapseThree" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                            <div class="accordion-body">
                                <div class="row row-cols-1 row-cols-lg-2 gy-3">
                                    ...
                                    $query = "SELECT customEventId, videoLink FROM event_media WHERE mediaType = 'video'";
                                    $result = $conn->query($query);
                                    ...
                                    if ($result->num_rows > 0) {
                                        while ($row = $result->fetch_assoc()) {
                                            ...
                                            echo "
                                            <iframe class='col' height='340' src='$videoLink' title='YouTube video player' frameborder='0' allow='accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share' referrerpolicy='strict-origin-when-cross-origin' allowfullscreen></iframe>";
                                        }
                                    } else {
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="volunteer-wrap text-center">
                        ...
                        <p class="text-center fs-2 text-dark fw-bolder">Help the poor who are suffer much in the world!</p>
                        <a href="donate.php" class="custom-btn">Donate now</a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row justify-content-between">
                    <div class="col-lg-4 col-sm-6">
                        <div class="footer-widget footer-about">
                            ...
                            <p>Help us to save lives during a natural disaster, get clean water running in the most remote areas, and much more.</p>
                    ...
                    <div class="col-lg-3 col-sm-5 offset-sm-1 offset-lg-0">
                        <div class="footer-widget">
                            ...
                            <ul class="footer-contact">
                                <li><i class="fa fa-home"></i><span>Plot 21 Mato Estate Iwajowa, Off Ifedapo Street Akingbade, Ibadan, Oyo State.</span></li>
                                <li><i class="fa fa-phone"></i><span><a href="tel:+2347051196113">+234 705 119 6113</a><br><a href="tel:+2347051196129">+234 705 119 6129</a></span></li>
                                <li><i class="fa fa-envelope"></i><span><a href="mailto:info@mmcharityfoundation.com"></a>info@mmcharityfoundation.com</span></li>
                            </ul>
                        </div>
                    </div>
                </div>
