    ...
    <section class="event-page page-padding">
        <div class="container">
            <div class="row">
                ...
                $eventsQuery = "SELECT customEventId, eventName, eventDescription, eventDate, eventLocation FROM events LIMIT $limit OFFSET $offset";
                ...
                <div class="event-list">
                    ...
                    <div class="single-event">
                        <figure class="event-thumb" style="background: url('images/events/flyers-1.jpg') no-repeat center top / cover;">
