            ...
            <div class="container-fluid p-3 p-md-4 p-lg-5">
                <div class="row">
                    <div class="col-md-8 mt-3 mt-md-0">
                        <p class="heading-1">View Event</p>
                    ...
                    <div class="col-md-4 d-flex align-items-center justify-content-md-end mt-3 mt-md-0">
                        <a href="add-event.php" class="btn bg-warning text-dark p-2 px-4">
                            Add Event<i class="fa-regular fa-add ps-2"></i>
                        </a>
                    </div>
                </div>
                ...
                <div class="mt-4 table-responsive">
                    ...
                    <table class="table table-hover" id="example">
                        <thead class="table-dark">
                            <tr>
                                <th class="py-3">Event No</th>
                                <th class="py-3">Event Name</th>
                                <th class="py-3">Event Location</th>
                                <th class="py-3">Event Date</th>
                                <th class="py-3">Event Budget</th>
                                <th class="py-3">Event Description</th>
